...
В игре откройте карту (клавиша M)
...
О: Нет, достаточно один раз откалибровать под ваше разрешение экрана.

В: Работает ли программа в полноэкранном режиме?
О: Да, но не на всех системах, если включен режим "Поверх всех окон" (кнопка 🔝), Если не работает, используем Alt+Tab.
